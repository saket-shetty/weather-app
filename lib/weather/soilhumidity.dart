...
class soilhumidity extends StatefulWidget {
  @override
  _soilhumidityState createState() => _soilhumidityState();
}
...
class _soilhumidityState extends State<soilhumidity> {
    ...
    for(var x=0; x<=5; x++){
      item.add(makeGroupDatasoil(days[x], weatherdata[x]));
    }
  ...
  BarChartGroupData makeGroupDatasoil(int x, double y) {
